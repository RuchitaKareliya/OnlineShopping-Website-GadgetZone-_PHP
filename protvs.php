...
<body>
	...
	<!-- sony TV start -->
		...
		<h1 class="heading"> Sony <span>Telvision</span> </h1>
			<td>
				<form>
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php 
										$query1="select *, categories_name, company from products where categories_name = 'tv' and company = 'sony' ";
					...
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php
									include("connection.php");
									$query1="select *, categories_name, company from products where categories_name = 'tv' and company = 'panasonic' ";
									$pquery=mysqli_query($conn,$query1);
									$i=1;
									echo "<table>";
								?>
					...
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php
									include("connection.php");
									$query1="select *, categories_name, company from products where categories_name = 'tv' and company = 'samsung' ";
									$pquery=mysqli_query($conn,$query1);
									$i=1;
									echo "<table>";
								?>
					...
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
								...
								<?php 
										$query1="select *, categories_name, company from products where categories_name = 'tv' and company = 'lg' ";
										$pquery=mysqli_query($conn,$query1);
										$i=1;
										echo "<table>";
					...
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
								...
								<?php 
										$query1="select *, categories_name, company from products where categories_name = 'tv' and company = 'redmi' ";
										$pquery=mysqli_query($conn,$query1);
										$i=1;
										echo "<table>";
